...
export default function HorizontalStepperNav() {
    ...
    return (
        <div className="w-full flex flex-col items-center py-6">
            <div className="relative flex justify-between items-start w-full max-w-md">
                {/* Connecting line */}
                <div
                    className="absolute bg-border z-0"
                    style={{
                        top: '12px', // Position line at circle center (6px radius + 6px from top)
                ...
                {steps.map((step) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div
                                className={cn(
                                    'text-xs mt-2 text-center min-h-[2.5rem] flex items-center justify-center',
